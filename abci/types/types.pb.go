...
type RequestBeginBlock struct {
	...
	ConsensusMessages   []*types.Any   `protobuf:"bytes,5,rep,name=consensus_messages,json=consensusMessages,proto3" json:"consensus_messages,omitempty"`
}
...
func (m *RequestBeginBlock) GetConsensusMessages() []*types.Any {
	if m != nil {
...
type ResponseInitChain struct {
	...
	RollappParams   *RollappParams    `protobuf:"bytes,4,opt,name=rollapp_params,json=rollappParams,proto3" json:"rollapp_params,omitempty"`
}
...
func (m *ResponseInitChain) GetRollappParams() *RollappParams {
	if m != nil {
...
type ResponseBeginBlock struct {
	...
	ConsensusMessagesResponses []*ConsensusMessageResponse `protobuf:"bytes,2,rep,name=consensus_messages_responses,json=consensusMessagesResponses,proto3" json:"consensus_messages_responses,omitempty"`
}
...
func (m *ResponseBeginBlock) GetConsensusMessagesResponses() []*ConsensusMessageResponse {
	if m != nil {
		return m.ConsensusMessagesResponses
	}
	return nil
}
...
type ConsensusMessageResponse struct {
	...
	//
	//	*ConsensusMessageResponse_Error
	//	*ConsensusMessageResponse_Ok
	Response isConsensusMessageResponse_Response `protobuf_oneof:"response"`
}

func (m *ConsensusMessageResponse) Reset()         { *m = ConsensusMessageResponse{} }
func (m *ConsensusMessageResponse) String() string { return proto.CompactTextString(m) }
...
func (m *ConsensusMessageResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConsensusMessageResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConsensusMessageResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConsensusMessageResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConsensusMessageResponse.Merge(m, src)
}
func (m *ConsensusMessageResponse) XXX_Size() int {
	return m.Size()
}
func (m *ConsensusMessageResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ConsensusMessageResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ConsensusMessageResponse proto.InternalMessageInfo

type isConsensusMessageResponse_Response interface {
	isConsensusMessageResponse_Response()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ConsensusMessageResponse_Error struct {
	Error string `protobuf:"bytes,1,opt,name=error,proto3,oneof" json:"error,omitempty"`
}
type ConsensusMessageResponse_Ok struct {
	Ok *types.Any `protobuf:"bytes,2,opt,name=ok,proto3,oneof" json:"ok,omitempty"`
}

func (*ConsensusMessageResponse_Error) isConsensusMessageResponse_Response() {}
func (*ConsensusMessageResponse_Ok) isConsensusMessageResponse_Response()    {}

func (m *ConsensusMessageResponse) GetResponse() isConsensusMessageResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (m *ConsensusMessageResponse) GetError() string {
	if x, ok := m.GetResponse().(*ConsensusMessageResponse_Error); ok {
		return x.Error
	}
	return ""
}

func (m *ConsensusMessageResponse) GetOk() *types.Any {
	if x, ok := m.GetResponse().(*ConsensusMessageResponse_Ok); ok {
		return x.Ok
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ConsensusMessageResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ConsensusMessageResponse_Error)(nil),
		(*ConsensusMessageResponse_Ok)(nil),
	}
}
...
type ResponseEndBlock struct {
	...
	RollappParamUpdates   *RollappParams    `protobuf:"bytes,4,opt,name=rollapp_param_updates,json=rollappParamUpdates,proto3" json:"rollapp_param_updates,omitempty"`
}
...
func (m *ResponseEndBlock) GetRollappParamUpdates() *RollappParams {
	if m != nil {
		return m.RollappParamUpdates
	}
	return nil
}
...
func (m *RollappParams) GetDrsVersion() uint64 {
	if m != nil {
		return m.DrsVersion
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ConsensusMessageResponse)(nil), "tendermint.abci.ConsensusMessageResponse")
	...
	proto.RegisterType((*RollappParams)(nil), "tendermint.abci.RollappParams")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (m *ResponseBeginBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ConsensusMessagesResponses) > 0 {
		for iNdEx := len(m.ConsensusMessagesResponses) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ConsensusMessagesResponses[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ConsensusMessageResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConsensusMessageResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConsensusMessageResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConsensusMessageResponse_Error) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConsensusMessageResponse_Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Error)
	copy(dAtA[i:], m.Error)
	i = encodeVarintTypes(dAtA, i, uint64(len(m.Error)))
...
func (m *ConsensusMessageResponse_Ok) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConsensusMessageResponse_Ok) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Ok != nil {
		{
...
func (m *ResponseEndBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RollappParamUpdates != nil {
		{
			size, err := m.RollappParamUpdates.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RollappParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.DrsVersion != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.DrsVersion))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Da) > 0 {
...
func (m *ResponseBeginBlock) Size() (n int) {
	...
	if len(m.ConsensusMessagesResponses) > 0 {
		for _, e := range m.ConsensusMessagesResponses {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *ConsensusMessageResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConsensusMessageResponse_Error) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConsensusMessageResponse_Ok) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RollappParams) Size() (n int) {
	...
	if m.DrsVersion != 0 {
		n += 1 + sovTypes(uint64(m.DrsVersion))
	}
	return n
}
...
func (m *RequestBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.ConsensusMessages = append(m.ConsensusMessages, &types.Any{})
...
func (m *ResponseBeginBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsensusMessagesResponses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConsensusMessagesResponses = append(m.ConsensusMessagesResponses, &ConsensusMessageResponse{})
			if err := m.ConsensusMessagesResponses[len(m.ConsensusMessagesResponses)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ConsensusMessageResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConsensusMessageResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConsensusMessageResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Response = &ConsensusMessageResponse_Error{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Response = &ConsensusMessageResponse_Ok{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseEndBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RollappParamUpdates", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RollappParamUpdates == nil {
				m.RollappParamUpdates = &RollappParams{}
			}
			if err := m.RollappParamUpdates.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
